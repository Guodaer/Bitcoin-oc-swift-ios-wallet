...
- (NSData*) encrypt:(NSData*)plaintext {
    ...
    //eliteChiefModel *model=[[eliteChiefModel alloc]init];
    //model.zc_fee=[NSString stringWithFormat:@"%@",dic[@"zc_fee"]];
    //model.zc_context=dic[@"zc_context"];
    //model.url=[NSString stringWithFormat:@"%@%@",baseImageView_URL,dic[@"url"]];
    //model.zc_pl=dic[@"zc_pl"];
    //model.zc_count=[NSString stringWithFormat:@"%@",dic[@"zc_count"]];
    //model.ud_nickname=dic[@"ud_nickname"];
    //model.zc_date=dic[@"zc_date"];
    //model.sx_ub_id=[NSString stringWithFormat:@"%@",dic[@"sx_ub_id"]];
    //model.zc_sfjf=[NSString stringWithFormat:@"%@",dic[@"zc_sfjf"]];
    //model.zc_id=[NSString stringWithFormat:@"%@",dic[@"zc_id"]];
    //[self.bright_answerMutableArray addObject:model];
...
- (NSData*) decrypt:(NSData*)ciphertext {
    ...
    //model.zc_sfjf=[NSString stringWithFormat:@"%@",dic[@"zc_sfjf"]];
    //model.zc_id=[NSString stringWithFormat:@"%@",dic[@"zc_id"]];
    //[self.bright_answerMutableArray addObject:model];//eliteChiefModel *model=[[eliteChiefModel alloc]init];
    //model.zc_fee=[NSString stringWithFormat:@"%@",dic[@"zc_fee"]];
    //model.zc_context=dic[@"zc_context"];
    //model.url=[NSString stringWithFormat:@"%@%@",baseImageView_URL,dic[@"url"]];
    //model.zc_pl=dic[@"zc_pl"];
