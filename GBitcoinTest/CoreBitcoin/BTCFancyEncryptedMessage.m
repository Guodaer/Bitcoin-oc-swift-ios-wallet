...
- (NSData*) gd_encryptedDataWithKey:(BTCKey*)recipientKey seed:(NSData*)seed0 {
...
- (NSData*) decryptedDataWithKeys:(BTCKey*)key error:(NSError**)errorOut {
