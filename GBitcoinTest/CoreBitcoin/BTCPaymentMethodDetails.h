...
//[GDLiveDetailModel roomstatus_netRequestlvrid:eachModel.lvr_id success:^(GDLiveDetailModel *detailModel) {
//    [MBProgressHUD hideHUDForView:weakSelf.view animated:NO];
//    if (detailModel.result.code == 10) {
//        tosuccess_detailVC(detailModel);
//    }else{
//        //刷新列表
//        [BullTipsView showMessage:detailModel.result.info];
//        //            [weakSelf.ftCollectionView.mj_header beginRefreshing];
//    }
//} failed:^{
//    [MBProgressHUD hideHUDForView:weakSelf.view animated:NO];
//    todefault_detailVC();
